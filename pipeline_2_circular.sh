...
./circquant.py -v -a 5 -c 1 -i 50 -I 50000 -S -g genome/amel.gff -H circ/featureCounts.tsv -s circ/mapping/*.split.bed > circ/circ.mehl.quant.bed
...
./circstats.py -c -v -g genome/amel.gff < circ/circ.quant.bed | tee circ/circ.quant.stat.bed | wc -l     # 3511 (3487 with exon boundary)
...
./circquant.py -v -a 5 -c 1 -i 50 -I 50000 -S -g genome/amel.gff -H circ/featureCounts.tsv -s circ/mapping/*.bwa.ciri2.bed > circ/circ.ciri2.quant.bed
...
# splice site
./junctcut.py -v -g genome/amel.gff -f genome/amel.fna -l 0 -u 10 -d 10 < circ/circ.junctions.bed > circ/circ.junctions.splice.fna  # 1 without annotation
grep -i ........AGGT circ/circ.junctions.splice.fna | wc -l 	# 247 canonical splice signal
./seq2logo.sh < circ/circ.quant.5fold.splice.fna > circ/circ.quant.5fold.splice.ps
...
./junctcut.py -v -g genome/amel.gff -f genome/amel.fna -l 0 -u 500 -d 500 < circ/circ.junctions.bed > circ/circ.intron500.fna
./junctcut.py -v -g genome/amel.gff -f genome/amel.fna -l 5 -u 500 -d 500 < circ/circ.junctions.bed > circ/circ.intron505.fna
./junctcut.py -v -g genome/amel.gff -f genome/amel.fna -l 0 -u -500 < circ/circ.junctions.bed > circ/circ.5intron500.fna
./junctcut.py -v -g genome/amel.gff -f genome/amel.fna -l 0 -d -500 < circ/circ.junctions.bed > circ/circ.3intron500.fna
./junctcut.py -v -g genome/amel.gff -f genome/amel.fna -l 0 -u -1 < circ/circ.junctions.bed > circ/circ.5intron.fna
./junctcut.py -v -g genome/amel.gff -f genome/amel.fna -l 0 -d -1 < circ/circ.junctions.bed > circ/circ.3intron.fna
